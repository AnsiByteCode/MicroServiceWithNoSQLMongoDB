namespace ProductService
{
    ...
    public class Program
    {
        ...
        {
            var port = int.Parse(CartConfiguration.Port);
            var serviceDisplayName = CartConfiguration.CartServiceDisplayName;
            var serviceName = CartConfiguration.CartServiceName;
