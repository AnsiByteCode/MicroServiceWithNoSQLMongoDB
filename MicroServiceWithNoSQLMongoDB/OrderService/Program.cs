namespace OrderService
{
    ...
    public class Program
    {
        ...
        {
            var port = int.Parse(OrderConfiguration.Port);
            var serviceDisplayName = OrderConfiguration.OrderServiceDisplayName;
            var serviceName = OrderConfiguration.OrderServiceName;
